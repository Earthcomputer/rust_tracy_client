...
extern "C" {
	...
	TRACY_API uint32_t __tracy_alloc_lockable_ctx(struct SourceLocationData const* srcloc);
	...
	TRACY_API void __tracy_lockable_ctx_mark(struct SourceLocationData const* srcloc);
